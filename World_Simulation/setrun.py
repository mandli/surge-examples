...
import auto_gauges_world

#CLAW=os.environ['CLAW']
DATAWORLD = os.path.join(os.environ.get('worlddir', os.getcwd()))
# Time Conversions
...
def setrun(claw_pkg='geoclaw'):
    ...
    clawdata.lower[0] = 0      # west longitude
    clawdata.upper[0] = 360      # east longitude

    clawdata.lower[1] = -60       # south latitude
    clawdata.upper[1] = 60     # north latitude
    ...
    clawdata.num_cells[1] = int(clawdata.upper[1] - clawdata.lower[1]) \
        * degree_factor
# Number of grid cells for -180 to 0 domain
   # clawdata.num_cells[2] = int(clawdata.upper[2] - clawdata.lower[2]) \
    #    * degree_factor
   # clawdata.num_cells[3] = int(clawdata.upper[3] - clawdata.lower[3]) \
   #     * degree_factor
    # ---------------
    # Size of system:
    # ---------------
    ...
    # Autogauges plots gauges as the file runs
    auto_gauges_world.return_gauge_points(rundata)
