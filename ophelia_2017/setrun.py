...
def setgeo(rundata):
    ...
    data.storm_file = os.path.expandvars(os.path.join(os.getcwd(),'ophelia.storm'))
    ...
    # UK
    data.friction_regions.append([(-10.5, 51.5), (0, 60), [np.infty, -10.0, -200.0, -np.infty], [0.030, 0.012, 0.022]])
