...
def setrun(claw_pkg='geoclaw'):
    ...
    amrdata.refinement_ratios_y = [2, 2, 2, 6, 8] #   They were 16, I changed them to 8
    ...
    # Mobile observation
    regions.append([5, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -88.18, -87.88, 30.30, 30.70])
    # Pensacola gauge
    regions.append([5, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -87.36, -87.06, 30.15, 30.45])
    # Islands
    regions.append([8, 8, rundata.clawdata.t0, rundata.clawdata.tfinal,  -88.346467, -87.659412, 30.206186, 30.289004])
    #regions.append([5, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, x1, x2, y1, y2])
    #regions.append([5, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, x1, x2, y1, y2])
    # NOT Gauges from Ike AWR paper (2011 Dawson et al)
    
    # Dauphin Island, AL
    rundata.gaugedata.gauges.append([1, -88.130710, 30.243971,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])

    # Pensacola, FL
    rundata.gaugedata.gauges.append([2, -87.211667, 30.4,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])

    # Gulf Shores, AL
    rundata.gaugedata.gauges.append([3, -87.690078, 30.243547,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    
    # Bayou La Batre, AL
    rundata.gaugedata.gauges.append([4, -88.329596, 30.397584,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])

    # Mobile (by the USS Alabama), AL
    rundata.gaugedata.gauges.append([5, -88.004458, 30.683415,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    #clawutil.data.get_remote_file(
    #               "http://ftp.nhc.noaa.gov/atcf/archive/1979/bal111979.dat.gz")
    ...
    frederic.time_offset = datetime.datetime(1979, 9, 13, 3)

    frederic.write(data.storm_file, file_format='geoclaw')
