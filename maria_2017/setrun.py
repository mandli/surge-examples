...
def setrun(claw_pkg='geoclaw'):
    ...
    # changed the numbers to reflect GEBCO data
    clawdata.lower[0] = -82.0      # west longitude
    clawdata.upper[0] = -52.0      # east longitude

    clawdata.lower[1] = 11.0       # south latitude
    ...
    # may need to adjust ... refer to examples
    clawdata.order = 2
    ...
    # Gauges for Hurricane Maria, data collected from NOAA Inundations Website
    rundata.gaugedata.gauges.append([1, -64.697341, 17.749054,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([2, -65.443108, 18.152296,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([3, -65.5, 18.284355,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([4, -66.01, 18.6,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([5, -66.702255, 18.65,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    #refine_data.deep_depth
    #refine_data.max_level_deep
    ...
    # landfall date and time - (09/20/2017 ~ 11 UTC)
    maria.time_offset = datetime.datetime(2017, 9, 20, 11)

    maria.write(data.storm_file, file_format='geoclaw')
