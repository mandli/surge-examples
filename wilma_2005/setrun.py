...
def setrun(claw_pkg='geoclaw'):
    ...
    regions.append([6, 7, -21600, 21600, -81.8777777777777, -81.866666666666, 26.644444444444, 26.65])
    ...
    rundata.gaugedata.gauges.append([1, -81.82444444, 26.13166666666,
                                     rundata.clawdata.t0,
    ...
    rundata.gaugedata.gauges.append([2, -81.87027777777, 26.6472222222222,
                                     ...
                                     rundata.clawdata.tfinal])
    '''
    rundata.gaugedata.gauges.append([2, -82.15, 26.375, rundata.clawdata.t0, rundata.clawdata.tfinal])
    #8724580; Key West, Fl; 24,33,00 (24.5500000) + 81,48,28 (81.80777777777); End: 24,33,15 (24.554166666666) + 81,48,40 (81.811111111111)
    
    rundata.gaugedata.gauges.append([3, -81.80805555555, 24.5511111111111,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    ...
    rundata.gaugedata.gauges.append([4, -81.10638888888, 24.71083333333,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    atcf_path = os.path.join(scratch_dir, "bal252005.dat")
    ...
    #ike.time_offset = datetime.datetime(2005, 8, 29, 11)
    ike.time_offset = datetime.datetime(2005, 10, 24, 10, 30)
