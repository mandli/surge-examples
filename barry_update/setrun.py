...
def setrun(claw_pkg='geoclaw'):
    ...
    rundata.gaugedata.gauges.append([1, -91.383333, 29.36667,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Eugene Island, North of, Atchafalaya Bay, 8764314
...
##    topo_data.topofiles.append([3, topo_path])
    ...
    # include this info (7/13/2019 ~ 15 UTC)
    gordon.time_offset = datetime.datetime(2019, 7, 13, 15)
