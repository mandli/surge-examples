...
def setplot(plotdata=None):
    ...
    regions = {"Gulf": {"xlimits": (clawdata.lower[0], clawdata.upper[0]),
                        ...
                        "figsize": (6.4, 4.8)},
               "LaTex Shelf": {"xlimits": (-95, -90), #change (-92, -86)
                               "ylimits": (28, 31), #change (29, 32)
                               "figsize": (3, 2)}} # Expand domain of LaTex shelf: wider and larger
    ...
    end_date = datetime.datetime(2019, 7, 15, 15, 0)
    ...
    def gauge_afteraxes(cd):
        ...
        axes.set_yticks(np.arange(-2,2.5,0.5))
        axes.grid(True)
