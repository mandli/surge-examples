...
def setrun(claw_pkg='geoclaw'):
    ...
    regions.append([4, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -94.78-0.5, -94.78+0.5, 29.28-0.5, 29.28+0.5])
    regions.append([4, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -94.92-0.5, -94.92+0.5, 29.48-0.5, 29.48+0.5])
    regions.append([4, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -93.34-0.5, -93.34+0.5, 29.76-0.5, 29.76+0.5])
    regions.append([4, 6, rundata.clawdata.t0, rundata.clawdata.tfinal, -89.95-0.5, -89.95+0.5, 29.26-0.5, 29.26+0.5])


    #8771510 - Galveston Pleasure Pier, TX 

    rundata.gaugedata.gauges.append([1, -94.7905, 29.285,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])


    #Eagle Point, Galveston Bay, TX - Station ID: 8771013
    rundata.gaugedata.gauges.append([2, -94.918333,  29.48,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])

    
    #Sabine Pass, TX, USA 8770570

    rundata.gaugedata.gauges.append([3,  -93.3433333, 29.76833333,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])

     #GRAND ISLE, EAST POINT  8761724

    rundata.gaugedata.gauges.append([4, -89.956667, 29.263333,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    clawutil.data.get_remote_file(
                   "https://ftp.nhc.noaa.gov/atcf/archive/2002/bal132002.dat.gz")
    ...
    ike.time_offset = datetime.datetime(2002, 10, 3, 13)
