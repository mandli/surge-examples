...
def setplot(plotdata):
    ...
    stations = [('8721604', 'Trident Pier, Port Canaveral, FL'),
                ...
                ('8656483', 'Beaufort, Duke Marine Lab, NC')] # List in same format when you get more

    landfall_time = np.datetime64('2019-09-04T12:00') # Guess
    begin_date = datetime.datetime(2019, 8, 24)
    ...
    def gauge_afteraxes(cd):
        ...
        axes.set_xlim(np.array([-2.0, 3.0]) * 86400)
        axes.set_ylim([-2.0, 3.0])
        axes.set_xticks(np.linspace(-2, 3, 6) * 86400)
    ...
    plotaxes.scaled = True
    plotaxes.xlimits = [-86.0, -62.0]
    plotaxes.ylimits = [18.0, 46.0]
